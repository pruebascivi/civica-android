...
public class MarketPlacePageObjects extends PageObject {
	...
	private String btnMarketPlace = "//*[@name='iconTiendaVirtual']";
	...
	private String txtNotifyRappi = "//XCUIElementTypeStaticText[@name='Usted ya cuenta con seguro vigente, para más información escribanos por la opción necesita ayuda' or contains(@name, 'Cliente no esta dentro')]";
	private String btnNecesitoAyuda = "//XCUIElementTypeOther[@name='Ir a asesor virtual ¿Necesita ayuda?']";
	...
	private String btnAno = "android:id/date_picker_header_year";
	private String btnAnoEspecifico = "//*[@text='1997']";
	private String btnAceptar2 = "//XCUIElementTypeButton[@name='Done']";
	...
	private String btnFinalizar = "//*[@name='Finalizar']";
	...
	private String btnComprar = "//XCUIElementTypeButton[@name='Comprar']";
	...
	private String btnVolver = "(//XCUIElementTypeButton)[1]";
	...
	// Validar negocio
	private String txtRegistro = "(//XCUIElementTypeStaticText[@name=\"Registro exitoso\"])[2]";
	...
	private String btnRestaurantes = "//XCUIElementTypeStaticText[@name='Restaurantes']";
	private String btnBonoHamburguesas = "(//XCUIElementTypeOther/XCUIElementTypeImage[1])[15]";
	...
	private String btnVerMasHomeDaviplata = "//*[@name='Ver más botón']";
	private String btnTodosTiendaVirtual = "//*[@name='Todos']";
	...
	public void btnNecesitoAyuda() {
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath(this.btnNecesitoAyuda)));
		driver.findElement(By.xpath(this.btnNecesitoAyuda));
...
//		base.monto = txtValorPoliza.getText().replace(" ", "").replace("$", "").replace(".", "").replace(",", ".");
	...
	public void validarMensaje() {
		...
		boolean validacion = false;
		if (valor.contains("Cliente no esta dentro del rango de edad")) {
			validacion = true;
