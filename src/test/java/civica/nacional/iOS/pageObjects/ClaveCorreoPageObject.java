...
// funciones Cambiar Clave
	...
	private String txtCambioFallido = "(//XCUIElementTypeStaticText)[4]";
	private String txtCambioFallidoCambioFallido = "//XCUIElementTypeStaticText[@name='Error en cambio de clave']";
	private String txtCambioCorreoExitoso = "//XCUIElementTypeStaticText[@name='Solicitud de cambio de correo exitoso. En las próximas 24 horas quedará actualizado su correo.']";
...
//Funciones cambiar Clave
	...
	public void cerrarMensajeCambioClaveExitoso() {
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(this.mensajeCambioClaveExitoso)));
		driver.findElement(By.xpath(this.mensajeCambioClaveExitoso)).click();
	}
...
// ************************************************Funciones Cambio De Correo************************************************************
	...
	public void validarCambioDeCorreoExitoso() {
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath(this.txtCambioFallido)));
		String txtCambioExitoso = driver.findElement(By.xpath(this.txtCambioFallido)).getText();
