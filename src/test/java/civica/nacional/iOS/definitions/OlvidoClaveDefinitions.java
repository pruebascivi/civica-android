...
import civica.nacional.iOS.steps.OlvidoClaveSteps;
...
public class OlvidoClaveDefinitions {
	...
	public void consultoNumeroCelularEnRedeban(String numeroDocumento) throws Exception {
		base.numeroCelularOtp = stepsWebRedeban.consultaNumeroCelular(numeroDocumento);
	...
	public void consultoEnLatiniaLaOtp() throws Exception {
		stepsOlvidoClave.consultarOtpLatinia(base.numeroCelularOtp);
	}
	...
	public void consultoEnLatiniaLaOtpOlvidoClave() throws Exception {
		stepsOlvidoClave.consultarOtpLatiniaOlvidoClave(base.numeroCelularOtp);
	}
