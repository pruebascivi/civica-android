...
public class MeterPlataSteps{
	...
	public void validarOpcionMeterPlata() throws Exception {
		...
		utilidad.tomaEvidencia("Validar que se encuentre presente la opción meter plata en el Home de la app");
	}
	...
	public void validarOpcionMeterPlataMH() throws Exception {
		...
		utilidadesTcs.validateStatusElement(estado);
		utilidad.tomaEvidencia("Validar que se encuentre presente la opcion meter plata en el menú hamburguesa");
	}
	
	@Step
	public void ingresarMenuHamburguesaPerfilPersona() throws Exception {
		utilidad.tomaEvidencia("Ingresar a menu hamburguesa");
	...
	public void clicBotonMeterPlata() throws Exception {
		...
		utilidad.tomaEvidencia("Clic botón meter plata desde el home DaviPlata");
	}
	...
	public void validarOpcionesMeterPlata() throws Exception {
		...
		utilidadesTcs.validateStatusElement(estado);
		utilidad.tomaEvidencia("Validar que se encuentre presente las opciones para meter plata desde el home");
	}
	
	@Step
	public void regresarAlHomeDesdeModuloMeterPlata() throws Exception {
		utilidad.tomaEvidencia("Clic botón (<) regreso a home");
	...
	public void ingresarBtnMeterPlataMH() throws Exception {
		...
		utilidad.esperaMiliseg(500);
		utilidad.tomaEvidencia("Clic botón meter plata desde menú hamburguesa");
	}
	...
	public void validarOpcionesMeterPlataMH() throws Exception {
		...
		utilidadesTcs.validateStatusElement(estado);
		utilidad.tomaEvidencia("Validar que se encuentre presente las opciones para meter plata desde el menu hamburguesa");
	}
	...
	public void clicBotonMeterPlataDesdeCualquierBanco() throws Exception {
		...
		utilidad.tomaEvidencia("Doy clic al botón meter plata 'Desde cualquier banco'");
	}
	...
	public void validarFormDatosMeterPlata() throws Exception {
		...
		utilidadesTcs.validateStatusElement(estado);
		utilidad.tomaEvidencia("Valido formulario de datos para meter plata 'Desde cualquier banco'");
	}
	
	@Step
	public void regresarAOpcionDondeQuieroMeterPlata() throws Exception {
		utilidad.tomaEvidencia("Doy clic al botón (<) regreso desde donde quiero meter plata");
	...
	public void ingresarAOpcionMeterPlataEnEfectivo() throws Exception {
		...
		utilidad.tomaEvidencia("Doy clic al botón meter plata 'En Efectivo'");
	}
	...
	public void validarPopUpComoMeterPlataEnEfectivo() throws Exception {
		...
		utilidadesTcs.validateStatusElement(estado);
		utilidad.tomaEvidencia("Valido PopUp informativo 'Cómo meter plata en efectivo' y botón 'Encontrar' activo");
	}
	...
	public void aceptarInfoPopUp() throws Exception {
		...
		utilidad.tomaEvidencia("Cliqueo botón ENCONTRAR dentro de POP UP Donde meter plata en Efectivo");
	}
	...
	public void validarPantallaGeoreferenciador() throws Exception {
		...
		utilidadesTcs.validateStatusElement(estado);
		utilidad.tomaEvidencia("Valido presencia de pantalla del georeferenciador: " + estado);
	}
	...
	public void regresarAModuloDesdeDondeMeterPlata() throws Exception {
		...
		utilidad.esperaMiliseg(2000);
		utilidad.tomaEvidencia("Clic botón (<) regreso a desde donde meter plata");
	}
	...
	public void ingresarNumCel(String numCelularEspecial) {
		...
		utilidad.tomaEvidencia("Ingreso a campo y digito número de celular especial");
	}
	...
	public void validarLongitudNumeroCelular() {
		...
		utilidad.tomaEvidencia("Valido longitud número celular ingresado es: " + longitudCelular + "dígitos");
	}
	...
	public void validarSoloPermitidoCaracateresNumericos() {
		...
		utilidad.tomaEvidencia("Valido que solo se permitan caracteres numéricos: " + sonValoresNumericos);
	}
	...
	public void limpiarCampoNumIngresado() {
		...
		utilidad.esperaMiliseg(1000);
		utilidad.tomaEvidencia("Limpio campo de número ingresado");
	}
	...
	public void validarNumIngresadoEmpiezaEnTres() {
		...
		utilidad.tomaEvidencia("Valido que el número ingresado debe empezar en tres");		
	}
	...
	public void confirmarNumCelEspecial(String confirmarNumCelularEspecial) {
		...
		utilidad.tomaEvidencia("Confirmo número de celular especial");
	}
	...
	public void validarLongitudNumeroCelularConfirmacion() {
		...
		String longitudCelular = utilidadesTcs.validarLongitudNumerica(valorExtraido, 10);
		utilidad.tomaEvidencia("Valido longitud número celular de confirmación ingresado es: " + longitudCelular + "dígitos");
	}
	...
	public void validarSoloPermitidoCaracateresNumericosConfirmacionCel() {
		String valorExtraido = utilidadesTcs.obtenerTexto("xpath", meterPlataPageObjects.CAMPO_CONFIRME_NUMERO_CEL);
		String sonValoresNumericos = utilidadesTcs.validarCaracteresNumericos(valorExtraido);
		utilidad.tomaEvidencia("Valido que solo se permitan caracteres numéricos en confirmación de número: " + sonValoresNumericos);
	}
	...
	public void ingresarNumCelConfirmacionDiferenteDeTres(String numCelularDiferenteTres) {
		...
		utilidad.tomaEvidencia("Ingreso a campo y digito número de celular de confirmación");
	}
	...
	public void validarNumCelConfirmaciónEmpieceEnTres() {
		...
		utilidad.tomaEvidencia("Valido que el número de confirmación ingresado debe empezar en tres");		
	}
}
