...
Feature: casos Excepcion 4x1000
  ...
  Scenario Outline: CP03300M_SYS_Validar que deje realizar el proceso de Exención de 4x1000
    ...
    Examples: 
      ...
      ##@externaldata@D:/ArchivosRobotMovil/Exencion4x1000/Exencion4x1000.xlsx@CP03300M
      | "CC"   | "1020770034" | "1342"     |
  ...
  Scenario Outline: CP03560M_SYS_Validar que no muestre link si el cliente es Excento
    ...
    Examples: 
      | tipoId | usuario      | contrasena |estado|
      ##@externaldata@D:/ArchivosRobotMovil/Exencion4x1000/Exencion4x1000.xlsx@CP03560M
      | "CC"   | "1020770028" | "1234"     |"Exenta"|

  @CP03320M @Excepcion4x100010
