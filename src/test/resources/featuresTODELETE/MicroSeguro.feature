...
Feature: Set De Casos Microseguros
  ...
  @CP02130M @ya
  Scenario Outline: CP02130M_SYS_Validar proceso de compra microseguro de vida opción 1 desde menú hamburguesa
    ...
    And completar flujo comprar seguroMH <opcion> <genero>
    ...
    Examples: 
      ...
      | "CC"   | "1020963963" | "1234"     | "1"    | "M"    |

  @CP02131M @ya
  Scenario Outline: CP02131M_SYS_Validar proceso de compra microseguro de vida opción 2 desde menú hamburguesa
    Given obtener numero celular actual en redeban bolsillos <usuario>
    And Consulté saldo disponible en redeban GMF
    And logout redeban al finalizar consulta
    And ingreso usuario y contrasena <tipoId> <usuario> <contrasena>
    ...
    Examples: 
      | tipoId | usuario      | contrasena | opcion | genero |
      | "CC"   | "10333050"   | "2580"     | "2"    | "M"    |

  @CP02140M @ya
  Scenario Outline: CP02140M_SYS_Validar proceso de compra microseguro de vida opción 1 con usuario GMF desde menú hamburguesa
    Given obtener numero celular actual en redeban bolsillos <usuario>
    And Consulté saldo disponible en redeban GMF
    And logout redeban al finalizar consulta
    And ingreso usuario y contrasena <tipoId> <usuario> <contrasena>
    ...
    Examples: 
      | tipoId | usuario    | contrasena | opcion | genero |
      | "CC"   | "10333052" | "2580"     | "1"    | "M"    |

  @CP02141M 
  Scenario Outline: CP02141M_SYS_Validar proceso de compra microseguro de vida opción 2 con usuario GMF desde menú hamburguesa
    Given obtener numero celular actual en redeban bolsillos <usuario>
    And Consulté saldo disponible en redeban GMF
    And logout redeban al finalizar consulta
    And ingreso usuario y contrasena <tipoId> <usuario> <contrasena>
    ...
    Examples: 
      | tipoId | usuario  | contrasena | opcion | genero |
      | "CC"   | "10050033" | "2589"     | "2"    | "M"    |

  @CP10719M @ya
  Scenario Outline: CP10719M_SYS_Validar proceso de compra microseguro de vida para un unico daviplata y muestre mensaje desde menú hamburguesa
    Given obtener numero celular actual en redeban bolsillos <usuario>
    And Consulté saldo disponible en redeban GMF
    And logout redeban al finalizar consulta
    And ingreso usuario y contrasena <tipoId> <usuario> <contrasena>
    ...
    Examples: 
      | tipoId | usuario    | contrasena | opcion | genero |
      | "CC"   | "10333053" | "2589"     | "1"    | "M"    |

  @CP02160M  @ya
  Scenario Outline: CP02160M_SYS_Validar proceso de compra microseguro de vida ingresando una fecha de nacimiento que sea menor a 18 años desde menú hamburguesa
  ...
  @CP02170M @ya
  Scenario Outline: CP02170M_SYS_Validar proceso de compra microseguro de vida opción 1 generando mensaje de fondos insuficientes desde menú hamburguesa.
    Given ingreso usuario y contrasena <tipoId> <usuario> <contrasena>
    When ingreso a tienda virtual desde MH
    And completar flujo comprar seguroMH <opcion> <genero>
  ...
  @CP02182M @YA
  Scenario Outline: CP02182M_SYS_Validar que el sistema debe aceptar TyC por opción 1 y por opción 2 se seguros de vida desde menú hamburguesa
    Given ingreso usuario y contrasena <tipoId> <usuario> <contrasena>
    When ingreso a tienda virtual desde MH
  ...
  @CP1111M @ya
  Scenario Outline: CP1111M_SYS_Validar proceso de compra microseguro de Bicicleta opción 1 desde menú hamburguesa
    Given obtener numero celular actual en redeban bolsillos <usuario>
    And Consulté saldo disponible en redeban GMF
    And logout redeban al finalizar consulta
    And ingreso usuario y contrasena <tipoId> <usuario> <contrasena>
    And ingreso a tienda virtual desde MH
  ...
  @CP1112M @ya
  Scenario Outline: CP1112M_SYS_Validar proceso de compra microseguro de Bicicleta opción 2 desde menú hamburguesa
  	Given obtener numero celular actual en redeban bolsillos <usuario>
    And Consulté saldo disponible en redeban GMF
    And logout redeban al finalizar consulta
    And ingreso usuario y contrasena <tipoId> <usuario> <contrasena>
  ...
  @CP02190M @ya
  Scenario Outline: CP02190M_SYS_Validar proceso de compra microseguro de Bicicleta opción 1 con cliente GMF desde menú hamburguesa
    Given obtener numero celular actual en redeban bolsillos <usuario>
    And Consulté saldo disponible en redeban GMF
    And logout redeban al finalizar consulta
    And ingreso usuario y contrasena <tipoId> <usuario> <contrasena>
  ...
  @CP02191M @ya
  Scenario Outline: CP02191M_SYS_Validar proceso de compra microseguro de Bicicleta opción 2 con cliente GMF desde menú hamburguesa
    Given obtener numero celular actual en redeban bolsillos <usuario>
    And Consulté saldo disponible en redeban GMF
    And logout redeban al finalizar consulta
    And ingreso usuario y contrasena <tipoId> <usuario> <contrasena>
  ...
  @CP02200M @ya
  Scenario Outline: CP02200M_SYS_Validar proceso de compra microseguro de Bicicleta opción 1 generando mensaje de fondos insuficientes desde menú hamburguesa
    Given ingreso usuario y contrasena <tipoId> <usuario> <contrasena>
    When ingreso a tienda virtual desde MH
  ...
  @CP02201M @ya
  Scenario Outline: CP02201M_SYS_Validar proceso de compra microseguro de Bicicleta opción 2 generando mensaje de fondos insuficientes desde menú hamburguesa
    Given ingreso usuario y contrasena <tipoId> <usuario> <contrasena>
    When ingreso a tienda virtual desde MH
    Then Completo flujo comprar seguro bicicleta <opcion>
    And Valido mensaje fondos insuficientes
  ...
  @CP02202M @ya
  Scenario Outline: CP02202M_SYS_Validar que el sistema debe aceptar TyC por opción 1 y por opción 2 se seguros de Bicicleta desde menú hamburguesa
    Given ingreso usuario y contrasena <tipoId> <usuario> <contrasena>
    When ingreso a tienda virtual desde MH
  ...
  @CP100064M @ya
  Scenario Outline: CP100064M_SYS_Validar proceso de compra microseguro de Mascotas opción 1 desde menú hamburguesa
    Given ingreso usuario y contrasena <tipoId> <usuario> <contrasena>
    When ingreso a tienda virtual desde MH
  ...
  @CP100063M @ya
  Scenario Outline: CP100063M_SYS_Validar proceso de compra microseguro de Mascotas opción 2 desde menú hamburguesa
    Given ingreso usuario y contrasena <tipoId> <usuario> <contrasena>
    When ingreso a tienda virtual desde MH
    ...
    Examples: 
      | tipoId | usuario      | contrasena | opcion | raza   |
      | "CC"   | "10050077" | "2589"     | "2"    | "gato" |

  @CP100065M @ya
  Scenario Outline: CP100065M_SYS_Validar proceso de compra microseguro de Mascotas opción 1 con cliente GMF desde menú hamburguesa
    Given ingreso usuario y contrasena <tipoId> <usuario> <contrasena>
    When ingreso a tienda virtual desde MH
    And Completo flujo comprar seguro mascota MH <opcion> <raza>
    Then validar compra de seguro
  ...
  @CP100066M @ya
  Scenario Outline: CP100066M_SYS_Validar proceso de compra microseguro de Mascotas opción 2 con cliente GMF desde menú hamburguesa
    Given ingreso usuario y contrasena <tipoId> <usuario> <contrasena>
    When ingreso a tienda virtual desde MH
    Then Completo flujo comprar seguro mascota MH <opcion> <raza>
    And validar compra de seguro
  ...
  @CP100067M @ya
  Scenario Outline: CP100067M_SYS_Validar proceso de compra microseguro de Mascotas opción 1 generando mensaje de fondos insuficientes desde menú hamburguesa
    Given ingreso usuario y contrasena <tipoId> <usuario> <contrasena>
    When ingreso a tienda virtual desde MH
    Then Completo flujo comprar seguro mascota MH <opcion> <raza>
    And Valido mensaje fondos insuficientes
  ...
  @CP100068M @ya
  Scenario Outline: CP100068M_SYS_Validar proceso de compra microseguro de Mascotas opción 2 generando mensaje de fondos insuficientes desde menú hamburguesa
    Given ingreso usuario y contrasena <tipoId> <usuario> <contrasena>
    When ingreso a tienda virtual desde MH
    Then Completo flujo comprar seguro mascota MH <opcion> <raza>
    And Valido mensaje fondos insuficientes
