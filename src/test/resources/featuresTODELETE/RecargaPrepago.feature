...
Feature: Agrupación de casos Recarga prepago
  ...
  @CP0331M @RecargaPrepago10
  Scenario Outline: CP0331M_SYS_Validar proceso de recarga desde tienda virtual para operador movistar y verificar campo switch en web redeban
